...
<script type="text/javascript" src="<?php echo base_url() ?>asset/dist/js/jquery.signature.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url() ?>asset/dist/js/jquery.ui.touch-punch.min.js"></script>
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>asset/dist/css/jquery.signature.css">
</body>
</html>