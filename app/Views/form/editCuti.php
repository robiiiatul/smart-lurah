<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <?= form_open_multipart(strtolower(session()->get('role')) . '/editCuti/' . $data['id_cuti']) ?>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="type" value="Cuti Tahunan" <?= $data['type'] == 'Cuti Tahunan' ? 'checked' : '' ?>>
                                    <label class="form-check-label mr-5">Cuti Tahunan</label>
                                    <input class="form-check-input" type="radio" name="type" value="Ijin Dengan Gaji (IDG)" <?= $data['type'] == 'Ijin Dengan Gaji (IDG)' ? 'checked' : '' ?>>
                                    <label class="form-check-label mr-5">Ijin Dengan Gaji (IDG)</label>
                                    <input class="form-check-input" type="radio" name="type" value="Ijin Tanpa Gaji (ITG)" <?= $data['type'] == 'Ijin Tanpa Gaji (ITG)' ? 'checked' : '' ?>>
                                    <label class="form-check-label mr-5">Ijin Tanpa Gaji (ITG)</label>
                                    <input class="form-check-input" type="radio" name="type" value="Cuti Hamil / Melahirkan" <?= $data['type'] == 'Cuti Hamil / Melahirkan' ? 'checked' : '' ?>>
                                    <label class="form-check-label">Cuti Hamil / Melahirkan</label>
                                </div>

                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="type" value="Ijin Datang Terlambat (IDT)" <?= $data['type'] == 'Ijin Datang Terlambat (IDT)' ? 'checked' : '' ?>>
                                    <label class="form-check-label mr-5">Ijin Datang Terlambat (IDT)</label>
                                    <input class="form-check-input" type="radio" name="type" value="Ijin Pulang Cepat (IPC)" <?= $data['type'] == 'Ijin Pulang Cepat (IPC)' ? 'checked' : '' ?>>
                                    <label class="form-check-label mr-5">Ijin Pulang Cepat (IPC)</label>
                                    <input class="form-check-input" type="radio" name="type" value="Ijin Berobat ke Dokter (IBD)" <?= $data['type'] == 'Ijin Berobat ke Dokter (IBD)' ? 'checked' : '' ?>>
                                    <label class="form-check-label mr-5">Ijin Berobat ke Dokter (IBD)</label>
                                    <input class="form-check-input" type="radio" name="type" value="Dinas Luar / Training" <?= $data['type'] == 'Dinas Luar / Training' ? 'checked' : '' ?>>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="date" class="form-control" id="date_from" name="date_from" value="<?= esc($data['date_from']) ?>" required>
                            </div>

                            <label for="date_until" class="col-sm-1 col-form-label">to</label>
                            <div class="col-sm-4">
                                <input type="date" class="form-control" id="date_until" name="date_until" value="<?= esc($data['date_until']) ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="keterangan" name="keterangan" value="<?= esc($data['keterangan']) ?>" required>
                            </div>
                        </div>
